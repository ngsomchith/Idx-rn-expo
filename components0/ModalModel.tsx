...
function ModalModel({ myImage }) {
  ...
  useEffect(() => {
    console.log("ModalModel31 value ", value, //Number(value.montantCB).toFixed(2)
    )
  }, [value])
    ...
    >
      ...
      <Modal // Modal-in
        ...
        <ThemedView style={{ //headerTitle Modal  wttonith close bu
          ...
          <ThemedTitle style={{ fontSize: 30 }}> Modal Gohome</ThemedTitle>
