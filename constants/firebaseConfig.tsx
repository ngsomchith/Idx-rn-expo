...
import {
    ...
    // , browserSessionPersistence, initializeAuth 
} from 'firebase/auth';
...
export const FirebaseInit = () => {
    ...
    // ------------------------ nouveau: mieux organisé mais  moins stable ?   
    ...
    if (Platform.OS === 'web') {
        ...
        if (firebaseApp[0]) {
            ...
            // const auth = getAuth();
            firebaseApp[1] = firebase.auth(); //getAuth();
            firebaseApp[2] = getFunctions();
            firebaseApp[3] = getFirestore();
